 ...
 Это реактос (модифицированный для курса ОС ИУ9 (буду дополнять по ходу его прохождения))  
...
Когда создали виртуальную машину, идем в  
==Настроить==  
==Порты==
==Порт 1==  
Режим порта: ==Перенаправить в файл==
Путь/адрес: ==*путь до желаемого адреса*==
